...
public class MyHashMap<K, V> extends MyAbstractMap<K, V> implements MyMap<K, V>, Cloneable, Serializable {
	...
	static final class EntrySpliterator<K, V> extends MyHashMapSpliterator<K, V>
		...
		@Override
		public boolean tryAdvance(Consumer<? super brian.cai.j.src.my.map.MyMap.Entry<K, V>> action) {
			// TODO Auto-generated method stub
			return false;
		}

		@Override
		public Spliterator<brian.cai.j.src.my.map.MyMap.Entry<K, V>> trySplit() {
			// TODO Auto-generated method stub
			return null;
		}
