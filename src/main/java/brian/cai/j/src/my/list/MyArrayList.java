...
package brian.cai.j.src.my.list;
...
public class MyArrayList<E> extends MyAbstractList<E>
	...
	private class SubList extends MyAbstractList<E> implements RandomAccess {
		...
		public Spliterator<E> spliterator() {
			checkForComodification();
			return new MyArrayListSpliterator<E>(MyArrayList.this, offset, offset + this.size, this.modCount);
		}
	}
	...
	static final class MyArrayListSpliterator<E> implements Spliterator<E> {
		...
		MyArrayListSpliterator(MyArrayList<E> list, int origin, int fence, int expectedModCount) {
		...
		public MyArrayListSpliterator<E> trySplit() {
			...
			return (lo >= mid) ? null : // divide range in half unless too small
					new MyArrayListSpliterator<E>(list, lo, index = mid, expectedModCount);
		}
